...
from knack.log import CLILogging, CLI_LOGGER_NAME
...
#        logger_name = logger.name if logger.name in (CLI_LOGGER_NAME, 'root') else 'root'
...
#    loggers = [logging.getLogger(), logging.getLogger(CLI_LOGGER_NAME)]

#    logging.getLogger(CLI_LOGGER_NAME).propagate = False
