...
class RedisCommandsLoader(AzCommandsLoader):
    ...
    def load_command_table(self, args):
        ...
        self.cli_command(__name__, 'redis create', redis_custom + 'cli_redis_create', client_factory=cf_redis,
        ...
        self.cli_command(__name__, 'redis patch-schedule set', redis_patch_operation + 'create_or_update',
                         client_factory=cf_patch_schedules)
        self.cli_command(__name__, 'redis patch-schedule delete', redis_patch_operation + 'delete',
                         client_factory=cf_patch_schedules)
        self.cli_command(__name__, 'redis patch-schedule show', redis_patch_operation + 'get',
                         client_factory=cf_patch_schedules)
        return self.command_table

    def load_arguments(self, command):
        self.register_cli_argument('redis', 'name', options_list=['--name', '-n'], help='Name of the redis cache.',
        ...
        self.register_cli_argument('redis', 'vm_size',
